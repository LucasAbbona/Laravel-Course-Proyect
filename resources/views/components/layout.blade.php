  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">MySocialMedia</a></h4>
        @auth
...
<footer class="border-top text-center small text-muted py-3">
  ...
  @auth
    <div id="chat-wrapper" class="chat-wrapper shadow border-top border-right border-left" data-username="{{auth()->user()->username}}" data-avatar="{{auth()->user()->avatar}}"></div>
  @endauth
